                ...
                <Grid xs={12} style={{ boxShadow: "none" }}>
                    <Item style={{ boxShadow: "none" }}>      <div className="inner-column">
                        ...
                        <div style={{width: "90%", margin: "0 auto"}}>                       
                            ...
                            <div className="text">Achieve radiant skin and healthy hair with Shynex. <span style={{ textDecoration: "underline" }}><Link to={"/contactus/"} style={{ textDecoration: "underline" }}>Book your appointment today </Link></span> and enhance your confidence and well-being. </div>
