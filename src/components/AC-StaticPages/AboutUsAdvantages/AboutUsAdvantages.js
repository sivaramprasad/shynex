            ...
            <div className='courseBanner'><img alt="Courses Banner" title='Courses Banner' src={courseBanner} /></div>
             ...
             <div className="inner-column">
                        ...
                        <div style={{ width: "90%", margin: "0 auto" }}> 
                            ...
                            <div className="texta"><span style={{ fontWeight: "700" }}>1. USFDA Approved Technol:</span> Experience the future of skin and hair care with Shynex. Our advanced Morpheus 8 machine offers unparalleled skin rejuvenation, while the Soprano Titanium ensures the most effective laser hair removal available today.</div>
